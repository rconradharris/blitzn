...
public class SetTime extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<?> durationAdapter = ArrayAdapter.createFromResource(
                this, R.array.duration_choices, android.R.layout.simple_spinner_item);
        durationAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        durationSpinner.setAdapter(durationAdapter);
        
        // Pre-pop the duration spinner
        String[] durationChoices = getResources().getStringArray(R.array.duration_choices);
        int durationSelection = getIndexOfChoice(durationChoices, extras.getInt("durationMinutes"));
        ...
        String[] incrementChoices = getResources().getStringArray(R.array.increment_choices);
        int incrementSelection = getIndexOfChoice(incrementChoices, extras.getInt("incrementSeconds"));
